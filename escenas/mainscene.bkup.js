...
export default class MainScene extends Phaser.Scene {
	...
	create() {
		...
		this.events.on('camionetaDispara', (camionetaX) => {
			this.onCamionetaDispara(camionetaX);});

		this.events.on('camionetaHaSalido', ()=>console.log("camionetaHaSalido"));

		this.events.on('ultimaCamionetaHaSalido', ()=> {
			console.log("🌛 ultimaCamionetaHaSalido");
			this.onUltimaCamionetaHaSalido();});
